@ECHO OFF
SETLOCAL
SET _tserver1=time.google.com
:SET _tserver1=ntp.ubuntu.com
SET _tserver=%~1
IF NOT DEFINED _tserver SET _tserver=%_tserver1%
>nul net start W32Time
>nul w32TM /config /syncfromflags:manual /manualpeerlist:%_tserver%
>nul w32tm /config /update
>nul w32tm /resync
ENDLOCAL
GOTO :EOF
